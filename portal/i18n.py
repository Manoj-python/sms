...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "pin_title": {
        "en": "Enter your PIN", "te": "మీ PIN నమోదు చేయండి",
        "hi": "अपना PIN दर्ज करें", "kn": "ನಿಮ್ಮ PIN ನಮೂದಿಸಿ",
    },
    "enter_pin": {
        "en": "6-digit PIN for", "te": "దీని కోసం 6 అంకెల PIN",
        "hi": "इसके लिए 6 अंकों का PIN", "kn": "ಇದಕ್ಕಾಗಿ 6-ಅಂಕಿಗಳ PIN",
    },
    "unlock": {"en": "Unlock", "te": "అన్‌లాక్ చేయండి", "hi": "अनलॉक करें", "kn": "ಅನ್‌ಲಾಕ್ ಮಾಡಿ"},
    "pin_wrong": {
        "en": "Incorrect PIN. {remaining} attempt(s) remaining.",
        "te": "తప్పు PIN. {remaining} ప్రయత్నాలు మిగిలి ఉన్నాయి.",
        "hi": "गलत PIN। {remaining} प्रयास शेष हैं।",
        "kn": "ತಪ್ಪು PIN. {remaining} ಪ್ರಯತ್ನಗಳು ಉಳಿದಿವೆ.",
    },
    "pin_locked": {
        "en": "Too many incorrect attempts. Please login again with OTP.",
        "te": "చాలా తప్పు ప్రయత్నాలు. దయచేసి OTPతో మళ్లీ లాగిన్ అవ్వండి.",
        "hi": "बहुत अधिक गलत प्रयास। कृपया OTP से दोबारा लॉगिन करें।",
        "kn": "ಹಲವಾರು ತಪ್ಪು ಪ್ರಯತ್ನಗಳು. ದಯವಿಟ್ಟು OTP ಮೂಲಕ ಮತ್ತೆ ಲಾಗಿನ್ ಆಗಿ.",
    },
    "use_otp_instead": {
        "en": "Use OTP instead", "te": "బదులుగా OTP ఉపయోగించండి",
        "hi": "इसके बजाय OTP का उपयोग करें", "kn": "ಬದಲಿಗೆ OTP ಬಳಸಿ",
    },
    "err_invalid_pin": {
        "en": "PIN must be exactly 6 digits.", "te": "PIN తప్పనిసరిగా 6 అంకెలు ఉండాలి.",
        "hi": "PIN ठीक 6 अंकों का होना चाहिए।", "kn": "PIN ನಿಖರವಾಗಿ 6 ಅಂಕಿಗಳಾಗಿರಬೇಕು.",
    },
    "pin_confirm_mismatch": {
        "en": "The two PINs don't match.", "te": "రెండు PINలు సరిపోలడం లేదు.",
        "hi": "दोनों PIN मेल नहीं खाते।", "kn": "ಎರಡು PIN ಗಳು ಹೊಂದಿಕೆಯಾಗುತ್ತಿಲ್ಲ.",
    },
    "set_pin_title": {
        "en": "Set up quick PIN unlock", "te": "త్వరిత PIN అన్‌లాక్‌ను సెటప్ చేయండి",
        "hi": "त्वरित PIN अनलॉक सेट करें", "kn": "ತ್ವರಿತ PIN ಅನ್‌ಲಾಕ್ ಸೆಟಪ್ ಮಾಡಿ",
    },
    "set_pin_description": {
        "en": "Skip OTP next time on this device — enter a 6-digit PIN instead.",
        "te": "ఈ పరికరంలో తదుపరిసారి OTP అవసరం లేదు — బదులుగా 6 అంకెల PIN నమోదు చేయండి.",
        "hi": "इस डिवाइस पर अगली बार OTP छोड़ें — इसके बजाय 6 अंकों का PIN दर्ज करें।",
        "kn": "ಈ ಸಾಧನದಲ್ಲಿ ಮುಂದಿನ ಬಾರಿ OTP ಅಗತ್ಯವಿಲ್ಲ — ಬದಲಿಗೆ 6-ಅಂಕಿಗಳ PIN ನಮೂದಿಸಿ.",
    },
    "new_pin": {"en": "New PIN", "te": "కొత్త PIN", "hi": "नया PIN", "kn": "ಹೊಸ PIN"},
    "confirm_pin": {
        "en": "Confirm PIN", "te": "PINని నిర్ధారించండి", "hi": "PIN की पुष्टि करें", "kn": "PIN ಖಚಿತಪಡಿಸಿ",
    },
    "set_pin_button": {
        "en": "Set PIN", "te": "PIN సెట్ చేయండి", "hi": "PIN सेट करें", "kn": "PIN ಸೆಟ್ ಮಾಡಿ",
    },
    "pin_enabled_success": {
        "en": "Quick PIN unlock is now enabled on this device.",
        "te": "ఈ పరికరంలో త్వరిత PIN అన్‌లాక్ ఇప్పుడు ప్రారంభించబడింది.",
        "hi": "इस डिवाइस पर त्वरित PIN अनलॉक अब सक्षम है।",
        "kn": "ಈ ಸಾಧನದಲ್ಲಿ ತ್ವರಿತ PIN ಅನ್‌ಲಾಕ್ ಈಗ ಸಕ್ರಿಯಗೊಂಡಿದೆ.",
    },
    "device_trust_enabled_message": {
        "en": "Quick PIN unlock is enabled on this device.",
        "te": "ఈ పరికరంలో త్వరిత PIN అన్‌లాక్ ప్రారంభించబడింది.",
        "hi": "इस डिवाइस पर त्वरित PIN अनलॉक सक्षम है।",
        "kn": "ಈ ಸಾಧನದಲ್ಲಿ ತ್ವರಿತ PIN ಅನ್‌ಲಾಕ್ ಸಕ್ರಿಯಗೊಂಡಿದೆ.",
    },
    "forget_device": {
        "en": "Forget this device", "te": "ఈ పరికరాన్ని మర్చిపోండి",
        "hi": "इस डिवाइस को भूल जाएं", "kn": "ಈ ಸಾಧನವನ್ನು ಮರೆತುಬಿಡಿ",
    },
    "mobile_login": {
    ...
    "pay_via_phonepe": {
        "en": "Pay via PhonePe (UPI / Cards)", "te": "ఫోన్‌పే ద్వారా చెల్లించండి (UPI / కార్డులు)",
        "hi": "फोनपे से भुगतान करें (UPI / कार्ड)", "kn": "ಫೋನ್‌ಪೇ ಮೂಲಕ ಪಾವತಿಸಿ (UPI / ಕಾರ್ಡ್‌ಗಳು)",
    },
    "sms_link": {
    ...
    "no_loans": {
        "en": "No active loans available for this account. Please contact us on WhatsApp for any further details.",
        "te": "ఈ ఖాతాకు యాక్టివ్ రుణాలు అందుబాటులో లేవు. మరిన్ని వివరాల కోసం దయచేసి WhatsApp లో మమ్మల్ని సంప్రదించండి.",
        "hi": "इस खाते के लिए कोई सक्रिय ऋण उपलब्ध नहीं है। अधिक जानकारी के लिए कृपया हमें WhatsApp पर संपर्क करें।",
        "kn": "ಈ ಖಾತೆಗೆ ಯಾವುದೇ ಸಕ್ರಿಯ ಸಾಲ ಲಭ್ಯವಿಲ್ಲ. ಹೆಚ್ಚಿನ ವಿವರಗಳಿಗಾಗಿ ದಯವಿಟ್ಟು WhatsApp ನಲ್ಲಿ ನಮ್ಮನ್ನು ಸಂಪರ್ಕಿಸಿ.",
    },
    # errors
    ...
    "loan_blocked": {
        "en": "Access to this loan has been restricted. Please contact us on WhatsApp for more details.",
        "te": "ఈ రుణానికి యాక్సెస్ నిలిపివేయబడింది. మరిన్ని వివరాల కోసం దయచేసి WhatsApp లో మమ్మల్ని సంప్రదించండి.",
        "hi": "इस ऋण तक पहुंच प्रतिबंधित कर दी गई है। अधिक जानकारी के लिए कृपया हमें WhatsApp पर संपर्क करें।",
        "kn": "ಈ ಸಾಲಕ್ಕೆ ಪ್ರವೇಶವನ್ನು ನಿರ್ಬಂಧಿಸಲಾಗಿದೆ. ಹೆಚ್ಚಿನ ವಿವರಗಳಿಗಾಗಿ ದಯವಿಟ್ಟು WhatsApp ನಲ್ಲಿ ನಮ್ಮನ್ನು ಸಂಪರ್ಕಿಸಿ.",
    },
    "view_statement": {
